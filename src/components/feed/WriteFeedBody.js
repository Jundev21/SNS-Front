            ...
            <BodyWrapper>
                ...
                <form>
                    <div className="form-group pt-4">
                        ...
                        <input type="email" className="form-control p-2" id="title1" placeholder="제목을 입력해주세요."
                    ...
                    <div className="form-group pt-3">
                        ...
                        <textarea className="form-control mh-100" id="content1" rows="8" placeholder="내용을 입력해주세요."
